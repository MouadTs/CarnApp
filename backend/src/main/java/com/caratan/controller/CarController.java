...
public class CarController {
    ...
    public ResponseEntity<Map<String, String>> getMakeDetails(@PathVariable String makeName) {
        ...
        switch (makeName.toLowerCase()) {
            ...
            case "bmw":
                ...
                break;
            case "mpv":
                siteUrl = "https://www.google.com/search?q=mpv+cars";
                break;
            case "pickup":
                siteUrl = "https://www.google.com/search?q=pickup+trucks";
                break;
            case "van":
                siteUrl = "https://www.google.com/search?q=van+vehicles";
                break;
            default:
    ...
    public ResponseEntity<String> getMakeLogo(@PathVariable String makeName) {
        String makeNameLower = makeName.toLowerCase();
        // Check if we have a specific logo for this make
